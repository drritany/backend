 ...
 */
productSchema.statics.createProduct = async function (category, subCategory, name, images, videos, price, orders, description, specification) {
    let slashedPrice = (price * 100) / (100 - discount);
 ...
 */
productSchema.statics.getProductByCategory = async function (category) {
 ...
 */
productSchema.statics.getProductByPrice = async function (_order) {
 ...
 */
productSchema.statics.getProductBySearch = async function (query) {
